<template>
  <!-- <div id="firearmsAlarmStatistics">
    ...
    <el-select class="selectRange" v-model="value" placeholder="请选择">
      <el-option
   ...
   <div class="app-container" id="firearmsAlarmStatistics">
    <div class="filter-container">
      <el-input
 ...
 <el-table-column label="枪支编号" width="150px" align="center">
